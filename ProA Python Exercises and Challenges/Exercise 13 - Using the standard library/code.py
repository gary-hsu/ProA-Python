## In this final exercise, you will be testing out some standard modules that you can use.

# 1. Import and use the datatime module to print out the current system time.


# 2. Import and use the pprint module to print out the following list.
...
# 3. Lastly, import the random module as r and write a function that gives a random number between 0 and 1.


#Copy your import statement into your quiz.

# Here is a complete list of modules that are available to the standard library: https://docs.python.org/3/library/
